...
export default function FinalCTA({ MONTHLY_PRICE, KIVANO_PURCHASE_URL }: FinalCTAProps) {
  ...
  return (
    <section className="py-24 lg:py-40 relative overflow-hidden bg-gradient-to-br from-[#2C5282] via-[#1E3A52] to-[#1a3a52]">
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div
          className="absolute bottom-20 right-20 w-96 h-96 bg-[#4A90E2]/10 rounded-full blur-3xl"
          animate={{
            x: [0, -50, 0],
            y: [0, 50, 0],
            scale: [1, 1.1, 1],
        ...
        >
          ...
          >
            ...
            <span className="relative">
              <span className="relative z-10">transformar</span>
              <motion.svg
          ...
          <motion.p
            ...
            className="text-xl lg:text-2xl text-[#E0F2FE] mb-12 max-w-3xl mx-auto leading-relaxed"
          >
            Junte-se aos profissionais que já estão usando o Titan Juros
          </motion.p>
          ...
          >
            <a href={KIVANO_PURCHASE_URL} target="_blank" rel="noopener noreferrer">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="relative group bg-white text-[#2C5282] hover:bg-gray-50 font-bold py-6 px-12 rounded-2xl text-xl transition-all duration-300 shadow-2xl hover:shadow-white/30 inline-flex items-center gap-3 overflow-hidden"
              >
