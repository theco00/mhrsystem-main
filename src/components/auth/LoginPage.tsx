...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    if (!formData.password) {
      setErrors({ password: 'Por favor, insira sua senha' });
      return;
    }
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-white via-blue-50 to-sky-50 dark:from-blue-950 dark:via-blue-900 dark:to-sky-900 flex items-center justify-center p-4 relative overflow-hidden">
      {/* Theme Toggle Button */}
